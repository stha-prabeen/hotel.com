...
<footer style="background-color: #393939;">
	...
	<div class="col-sm-4 hov">
		<img src="logo/logo4.png"width="200px"height="50px"/><br><br>
...
?>
	...
	<div class="col-sm-4 text-justify">
      ...
      <p style="color:white;"><strong>Address:&nbsp;</strong>Kathmandu Nepal</p>
      <p style="color:white;"><strong>Email-Id:&nbsp;</strong>hotel@gmail.com</p>
      <p style="color:white;"><strong>Contact Us:&nbsp;</strong>+9779880025468</p><br><br><br>
	</div>&nbsp;
...
<footer class="container-fluid text-center"style="background-color:#000408;height:40px;padding-top:10px;color:#f0f0f0;">
  <p>Develop By Hotels.com | All Rights Reserved 2021</p>
</footer>
